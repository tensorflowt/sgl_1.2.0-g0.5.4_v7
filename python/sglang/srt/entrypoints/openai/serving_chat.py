...
class OpenAIServingChat(OpenAIServingBase):
    ...
    def _convert_to_internal_request(
        ...
        if isinstance(processed_messages.prompt_ids, list):  
            input_token_count = len(processed_messages.prompt_ids)   
        else:  
            input_token_count = 0
        ...
        adapted_request.normalize_batch_and_arguments()
        logger.info(f"Chat request: rid={adapted_request.rid}, input_tokens={input_token_count}, messages={request.messages}")
